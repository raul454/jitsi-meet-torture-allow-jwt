  ...
  --*)
    ...
    for arg in "$@"; do
      ...
      case $optname in
        ...
        --p-to-p-enabled) MALLEUS_P_TO_P_ENABLED=$optvalue;;
...
-Dorg.jitsi.malleus.p_to_p_enabled=$MALLEUS_P_TO_P_ENABLED \
